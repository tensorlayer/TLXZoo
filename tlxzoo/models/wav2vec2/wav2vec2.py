...
class Wav2Vec2FeatureExtractor(Module):
    def __init__(self, config, name="", **kwargs):
        ...
        self.conv_layers = tlx.nn.SequentialLayer(conv_layers)
...
class Wav2Vec2Model(BaseModule):
    def __init__(self, config, name="", *inputs, **kwargs):
        super().__init__(config, name=name, *inputs, **kwargs)
        self.config = config
